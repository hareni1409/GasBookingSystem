...
session_start();
include "../../config.php";
$q = "select *from customers where isVerified =0";
$result = $con->query($q);
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
	<div class="container-fluid row">
		...
		<section style="width:83%;margin-left:240px;">
			<h2>List of Non verified Users</h2>
				...
				<tbody>
					...
					?>
							...
							<tr>
								...
								<td><a class="btn btn-primary" href="../verification/verify.php?userId=<?php echo $row['userId']; ?>">Verify Proof</a></td>
							</tr>
